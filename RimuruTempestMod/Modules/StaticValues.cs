...
namespace RimuruMod.Modules
{
    ...
    {
        internal static string descriptionText = "Rimuru is a skilled fighter who makes use of a wide arsenal of weaponry to take down his foes.<color=#CCD3E0>" + Environment.NewLine + Environment.NewLine
