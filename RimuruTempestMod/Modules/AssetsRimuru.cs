...
{
    internal static class AssetsRimuru
    {
        ...
        {                                                                
            ...
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream($"{csProjName}.rimuruSoundbank.bnk"))
            {
        ...
        internal static void PopulateAssets()
        {
            ...
            blacklightning = Modules.AssetsRimuru.mainAssetBundle.LoadAsset<GameObject>("BlackLightning");
            ...
            //devour effect
            devourEffect = Modules.AssetsRimuru.mainAssetBundle.LoadAsset<GameObject>("Devour");
            devourExtendedEffect = Modules.AssetsRimuru.mainAssetBundle.LoadAsset<GameObject>("DevourExtended");
            devourskillgetEffect = LoadEffect("SkillGet");
            //analyze effect
            analyzeEffect = Modules.AssetsRimuru.mainAssetBundle.LoadAsset<GameObject>("Analyze");
            //waterblade impact effect
            waterbladeimpactEffect = LoadEffect("WaterBladeImpact");
            //wet effect
            wetEffect = Modules.AssetsRimuru.mainAssetBundle.LoadAsset<GameObject>("WetEffect");

            //sword
            swordHitSoundEvent = CreateNetworkSoundEventDef("RimuruHit");

            //swordSwingEffect = Assets.LoadEffect("RimuruSwordSwing", true);
            swordSwingEffect = AssetsRimuru.LoadEffect("RimuruSwordSwing", true);
            swordHitImpactEffect = AssetsRimuru.LoadEffect("ImpactRimuruSlash");
            ...
            spherePrefab = Modules.AssetsRimuru.mainAssetBundle.LoadAsset<GameObject>("SphereIndicator");
